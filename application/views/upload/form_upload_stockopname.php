...
<div id="div1" >   
 <table class="tableA">
    <tr>
        <th colspan="2" align="center">Upload Stock Opname <span style="float:right;"><b>PLB Inventory</b>&nbsp;</span></th>
    </tr>
</table>
...
<form method="post" name="frmUpload" enctype="multipart/form-data" id="frmUpload" action="<?php echo site_url('upload/konfirmasi_stockopname'); ?>" onSubmit="return cekFileKirim(this.name); return false;">
<br />
<a href="<?php echo base_url().'/file/UploadDokStockOpname.xls';?>" style="text-decoration:none;"><img src='<?php echo base_url(); ?>img/tbl_xls.png' border="0" width="15">&nbsp;Contoh Format Data</a>
<br /><br />
