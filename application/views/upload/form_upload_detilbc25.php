...
<div id="div1" >   
 <table class="tableA">
    <tr>
        <th colspan="2" align="center">Upload Detil BC 2.5 <span style="float:right;"><b>GB Inventory</b>&nbsp;</span></th>
    </tr>
</table>
...
<br />
<a href="<?php echo base_url().'/file/UploadDetilBC25.xls';?>" style="text-decoration:none;"><img src='<?php echo base_url(); ?>img/tbl_xls.png' border="0" width="15">&nbsp;Contoh Format Data</a></font>
<br /><br />
