...
function konfirmasiData(banyakError,banyakData,banyakAda)
{
	if(banyakAda==(banyakData)){
		alert('Tidak dapat diproses.\nSemua kode barang pada tanggal stock opname tersebut sudah ada semua. Silahkan isi data barang lainnya.');
		return false;	
	}
	...
	if(banyakAda>0){
		if(confirm('Hanya kode barang yang belum terdaftar pada tanggal stockopname tersebut yang dapat diproses\nTambahkan ?')){
			proses(banyakData);		
		}else{		
			return false;	
		}
...
function proses(banyakData){
	$('#divLoading').html('<img src="' + base_url + 'img/_indicator.gif" alt=""> Loading...');
		var url = site_url + '/upload/insert_upload_stockopname/'+Math.random();//alert(url);return false;
			...
			function(data){
				...
				if(arrdata[1]=="Berhasil"){
					...
					$('#divLoading').attr('style','color:#0C0');
					  window.opener.location.href=site_url +'/inventory/daftar/stock_opname';
            		  self.close();
				}else{
...
<div id="div1" >   
 <table class="tableA">
    <tr>
        <th colspan="2" align="center">Upload Stock Opname<span style="float:right;"><b>GB Inventory</b>&nbsp;</span></th>
    </tr>
</table>
...
<tr>
	<th align="center" width="1%" style="background:#F0F0F0"><b>No.</b></th>
    ...
    <td align="center"  style="background:#F0F0F0"><b>Stock Opname</b></td>
    <td align="center"  style="background:#F0F0F0"><b>Kode Dok Masuk</b></td>
    <td align="center"  style="background:#F0F0F0"><b>Nomor Dok. Masuk</b></td>
    <td align="center"  style="background:#F0F0F0"><b>Tanggal Dok. Masuk</b></td>
    <td align="center"  style="background:#F0F0F0"><b>Jumlah</b></td>
    <td align="center"  style="background:#F0F0F0"><b>Keterangan</b></td>
</tr>
<?php if ($banyakData > 0) { ?>
