...
<div id="div1" >   
 <table class="tableA">
    <tr>
        <th colspan="2" align="center">Upload Proses Produksi</th>
    </tr>
</table>
...
<form method="post" name="frmUpload" enctype="multipart/form-data" id="frmUpload" action="<?php echo site_url('upload/konfirmasi_produksi'); ?>" onSubmit="return cekFileKirim(this.name); return false;">
<br />
<a href="<?php echo base_url().'assets/file/UploadDokPengerjaanSederhana.xls';?>" style="text-decoration:none;"><img src='<?php echo base_url(); ?>img/tbl_download.png' border="0" width="15">&nbsp;Contoh Format Data</a>&nbsp;&nbsp;<font color="#FF0000"><i><b>(Last Update 11 Jan 2012)</b></i></font>
<br /><br />
...
<input type="hidden" name="id" value="<?php echo $this->newsession->userdata('KODE_TRADER').($this->newsession->userdata('USER_ID')+1); ?>">
</form>
</div>
<br />
</div>
...
function cekFileKirim(namaForm)
{
	...
	{
		$("#loadingUpload").html('<img src="<?=base_url()?>assets/img/_indicator.gif">  Loading...');
