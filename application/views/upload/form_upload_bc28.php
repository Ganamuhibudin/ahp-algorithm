...
<div id="div1">
  <table class="tableA">
    <tr>
      <th colspan="2" align="center">Upload BC 2.8 <span style="float:right;"><b>PLB Inventory</b>&nbsp;</span></th>
    </tr>
  </table>
  ...
  <div style="padding:0 10px 0 10px;">
	<?php 	
		if($proses){
			echo "<br>";
			if($proses=="error"){
				echo '<input type="button" class="button" value="Upload Ulang" style="height:32px;" onclick="location.href=\''.site_url().'/uploadnew/bc28\'">&nbsp;<input type="button" class="button" value="  Batal  " onClick="self.close();" style="height:32px;"><br>';
				echo '<span style="color:green">'.$sukses.'</span>';
				echo '<span style="color:red">'.$error.'</span>';
			}else{
				echo '<input type="button" class="button" value="Upload Lagi" style="height:32px;" onclick="location.href=\''.site_url().'/uploadnew/bc28\'">&nbsp;<input type="button" class="button" value="  Tutup  " onClick="self.close();" style="height:32px;"><br>';
				echo '<span style="color:green">'.$sukses.'</span>';
				echo '<span style="color:red">'.$error.'</span>';	
			}
		}else{
   ...
   <?php echo $this->session->flashdata('txtuploadexcel'); ?>
    <form method="post" name="frmUpload" enctype="multipart/form-data" id="frmUpload" action="<?php echo site_url('uploadnew/proses_upload_bc28');  ?>" onSubmit="return cekFileKirim(this.name); return false;">
