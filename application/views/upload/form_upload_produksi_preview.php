...
function konfirmasiData(banyakError,banyakData){
	...
	if (konfirmasi)
	{
		...
		var url = site_url + '/upload/insert_upload_produksi/'+Math.random();
			...
			function(data){
				...
				if(arrdata[1]=="Berhasil"){
					$('#divLoading').attr('style','color:#0C0');
					 window.opener.location.href=site_url +'/produksi/daftar/hasil_produksi';
            		 self.close();
				}else{
...
<div id="div1">   
 <table class="tableA">
    <tr>
        <th colspan="2" align="center">Upload Proses Produksi<span style="float:right;"><b>GB Inventory</b>&nbsp;</span></th>
    </tr>
</table>
...
<tr>
    ...
    <td align="center" style="background:#F0F0F0"><b>Nomor Transaksi</b></td>
    <td align="center" style="background:#F0F0F0"><b>Tanggal</b></td>
    <td align="center" style="background:#F0F0F0"><b>Jam</b></td>
    <td align="center" style="background:#F0F0F0"><b>Kode Barang</b></td>
    <td align="center" style="background:#F0F0F0"><b>Uraian Barang</b></td>
    <td align="center" style="background:#F0F0F0"><b>Kode Penggunaan</b></td>
...
?>
<tr>
	<td colspan="11" align="center" valign="top">Tidak ada data yang terbaca</td>
</tr>
<?php } ?>
</table>
<br />
