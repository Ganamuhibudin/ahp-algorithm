...
<div id="div1" >   
 <table class="tableA">
    <tr>
        <th colspan="2" align="center">Upload Data Konversi <span style="float:right;"><b>PLB Inventory</b>&nbsp;</span></th>
    </tr>
</table>
...
<div style="padding-left:10px;">
	...
	<form method="post" name="frmUpload" enctype="multipart/form-data" id="frmUpload" action="<?php echo site_url('upload/konfirmasi_konversi'); ?>" onSubmit="return cekFileKirim(this.name); return false;">
	<br />
	<a href="<?php echo base_url().'assets/file/UploadDokKonversi.xls';?>" style="text-decoration:none;"><img src='<?php echo base_url(); ?>img/tbl_xls.png' border="0" width="15">&nbsp;Contoh Format Data</a>
	<br /><br />
	Silahkan memilih file: <input class="btn btn-default btn-flat" type="file" name="fileUpload">&nbsp;<font color="#FF0000"><i>(Ukuran File Max. 3 MB)</i></font>
	<br>
