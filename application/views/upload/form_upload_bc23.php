...
<div id="div1" >   
 <table class="tableA">
    <tr>
        <th colspan="2" align="center">Upload Data Dokumen BC 2.3 <span style="float:right;"><b>GBInventory</b>&nbsp;</span></th>
    </tr>
</table>
<table width="100%" class="tahapUpload">
</table>
<div style="padding-left:10px;">
<form method="post" name="frmUpload" enctype="multipart/form-data" id="frmUpload" action="<?php echo site_url('upload/konfirmasi_bc23'); ?>" onSubmit="return cekFileKirim(this.name); return false;">
<br /><br />
...
function cekFileKirim(namaForm){
	...
	if (fileext.toLowerCase() != 'b23')
	{
		alert ('Maaf, hanya file b23 yang dapat dikirim');
		cb.focus();
		return false;
	}
	else
