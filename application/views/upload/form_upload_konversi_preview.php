...
function konfirmasiData(banyakError,banyakData,banyakAda)
{
	...
	if (konfirmasi)
	{
		...
		var url = site_url + '/upload/insert_upload_konversi/'+Math.random();
		...
		$.post(url, {id: $('#id').val(),rowsAwal:$('#rowsAwal').val(),rowsAkhir:$('#rowsAkhir').val(),colsAwal:$('#colsAwal').val(),colsAkhir:$('#colsAkhir').val(),banyakData:$('#banyakData').val()},
			function(data){
				...
				if(arrdata[1]=="Berhasil"){
					...
					window.opener.location.href=site_url +'/inventory/daftar/konversi';
            		self.close();
				}else{
...
<tr>
	...
	<td align="center" style="background:#F0F0F0"><b>Nomor Konversi</b></td>
    ...
    <td align="center" style="background:#F0F0F0"><b>Subkontrak (Y/N)</b></td>
    <td align="center" style="background:#F0F0F0"><b>Keterangan</b></td>
    <td align="center" style="background:#F0F0F0"><b>No. Urut BB</b></td>
    <td align="center" style="background:#F0F0F0"><b>Kode Barang</b></td>
    <td align="center" style="background:#F0F0F0"><b>Jenis Barang</b></td>
    <td align="center" style="background:#F0F0F0"><b>Uraian Barang</b></td>
    <td align="center" style="background:#F0F0F0"><b>Jumlah</b></td>
