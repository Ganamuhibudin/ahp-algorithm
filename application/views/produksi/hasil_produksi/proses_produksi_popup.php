...
<form name="fHasilProduksi" id="fHasilProduksi" autocomplete="off">
    ...
    <td width="45%" valign="top">   
        <table width="100%" border="0">
           ...
           <tr>
                ...
                <td width="820">
                <input type="text" style="width:62%" name="JENIS_BARANG" id="JENIS_BARANG" readonly class="mtext" value="<?= $sess['JENIS_BARANG']; ?>" wajib="yes"/>
            </tr> 
            <tr>
            <td>Gudang</td>
            <td id="td-gudang-bb">
     ...
     <table width="100%" border="0">
     	<tr>
     		<td colspan="2" width="100%">	
               ...
               <a href="javascript:void(0);" class="btn btn-success btn-sm save" style="color:#FFFFFF" id="ok_" onclick="save_produksi('#fHasilProduksi','<?=$sess['ID']?>')"><span><span class="fa fa-save"></span>&nbsp;<?= ucfirst($act);?>&nbsp;</span></a>&nbsp;<a href="javascript:;" class="btn btn-warning btn-sm cancel" style="color:#FFFFFF" id="cancel_" onclick="cancel('fHasilProduksi');"><span><span class="icon-undo"></span>&nbsp;Reset&nbsp;</span></a><span class="msgdetil_">&nbsp;</span>
			</td>
		</tr>
	</table>
    </td>
