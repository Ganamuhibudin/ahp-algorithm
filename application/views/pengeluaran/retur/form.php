<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); 
	...
	$eventButton = "tb_search('barang','id_barang_1;kode_barang_1;jenis_barang_1;nama_barang_1;uraian_1;satuan_1','Kode Barang','fretur',680,445)";
...
<div class="content">
	<form name="fretur" id="fretur" action="<?= site_url()."/pengeluaran/".$action."/retur"?>" method="post" class="form-horizontal" role="form">
		...
		<table width="100%">
			<tr>
				<td width="50%">
					<table>
						<tr>
			            	<td width="35%">Nomor Transaksi</td>
							<td width="70%">
			...
			<tr>
				<td colspan="2">
				<a href="javascript:void(0)" class="btn btn-success btn-sm" onclick="save_post('#fretur')">
...
<script type="text/javascript">
	...
	function searchBarang(id) {
		tb_search('barang','id_barang_'+id+';kode_barang_'+id+';jenis_barang_'+id+';nama_barang_'+id+';uraian_'+id+';satuan_'+id+'','Kode Barang','fretur',680,445);
	}
