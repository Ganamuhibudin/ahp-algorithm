...
<tr>
    <td colspan="2"><b>Laporan Pengrusakan Barang</b></td>
</tr>
<tr>
     <td colspan="2">&nbsp;</td>
</tr>
<tr>
    ...
    <td width="92%">: <input type="text" name="TANGGAL_AWAL" id="TANGGAL_AWAL" onFocus="ShowDP('TANGGAL_AWAL');" wajib="yes" class="stext date">&nbsp; s/d&nbsp;<input type="text" name="TANGGAL_AKHIR" id="TANGGAL_AKHIR" onFocus="ShowDP('TANGGAL_AKHIR');" wajib="yes" class="stext date">
    </td>
</tr>
<tr>
    <td>Kode Barang </td>
   ...
   <a href="javascript:void(0);" class="button next" onclick="Laporan('frmLaporanOut','msg_laporan','divLapKeluar','<?= site_url()."/laporan/daftar_dok/pengrusakan";?>','laporan');"><span><span class="icon"></span>&nbsp;OK&nbsp;</span></a>       
    </td>
</tr>
<tr>
    <td>&nbsp;</td>
