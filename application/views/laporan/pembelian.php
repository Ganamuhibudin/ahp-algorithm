...
?>
<div class="header">
	<h3><strong><span class="icon-file-text">&nbsp;</span>Laporan Pembelian</strong></h3>
</div>
<div class="content">
    <form name="frmLaporan" id="frmLaporan">
        <table class="normal" cellpadding="2" width="100%">
            ...
            <tr>
            	<td>&nbsp;</td>
                <td>&nbsp;&nbsp;<a href="javascript:void(0);" class="btn btn-success btn-sm next" onclick="Laporan('frmLaporan','msg_laporan','divLapMutasi','<?= base_url()."index.php/laporan/daftar_dok/pembelian";?>','laporan');"><span><i class="fa fa-check"></i>&nbsp;Proses&nbsp;</span></a></td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;</td>
            </tr>
