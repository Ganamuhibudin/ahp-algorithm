...
<tr> 
    <td valign="top" colspan="2" class="border-t border-b">
        ...
        <tr>
            ...
            <td width="230pt" align="center" valign="top" class="border-r border-b">JENIS DOKUMEN</td>
            <td width="190pt" align="center"  valign="top" class="border-r border-b">NOMOR</td>
            <td width="110pt" align="center" valign="top" class="border-b">TANGGAL</td>
        </tr>
...
?>	
		<tr>
            ...
            <td valign="top" class="border-r" height="500pt"><?=$JENIS_DOKUMEN?></td>
            <td valign="top" class="border-r" height="500pt"><?=$NOMOR_DOKUMEN?></td>
            <td valign="top" align="left" height="500pt"><?=$TANGGAL_DOKUMEN?></td>
        </tr>
<?php 	
	}else{	
?>
