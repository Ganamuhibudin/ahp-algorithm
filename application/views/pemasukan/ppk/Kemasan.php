...
<?php if(!$list){?>
	<form id="fkemasan_" action="<?= site_url()."/pemasukan/kemasan/ppk"; ?>" method="post" autocomplete="off" list="<?= site_url()."/pemasukan/detil/kemasan/ppk" ?>">
                ...
                <td>Jenis Kemasan </td>
                    <td><div class="input-group" style="float:left; width:3em; margin-bottom:0px">
                      ...
                      <span class="input-group-btn">
                          <a href="javascript:void(0)" name="cari" id="cari" class="btn btn-primary btn-xs" style="vertical-align:top;height:27px " onclick="tb_search('kemasan','KODE_KEMASAN;urjenis_kemasan','Kode Kemasan','fkemasan_',650,445)" <?=$display?>><i class="fa fa-ellipsis-h"></i></a></span>
                      </div> &nbsp;
