...
<?php if (!$list) { ?>
	<form id="fbarang_" name="fbarang_" action="<?= site_url() . "/pemasukan/barang/ppk"; ?>" method="post" autocomplete="off" enctype="multipart/form-data" list="<?= site_url() . "/pemasukan/detil/barang/ppk" ?>">
        ...
        <table width="100%">
        	<tr>
                ...
                <td valign="top">
                    <table width="100%">
                    	<tr><td colspan="2" valign="top"><h5 class="smaller lighter blue"><b>Dokumen Pengeluaran</b></h5></td></tr>
                    	<tr>
                            <td>Kode Dokumen</td>
                            <td><div class="input-group" style="float:left; width:3em; margin-bottom:0px">
                        ...
                        <tr>
                            ...
                            <td><div class="input-group" style="width:3em;float:left;margin-bottom:0px;margin-right:5px"><input type="text" name="BARANG[TGL_DOKUMEN]" id="TGL_DOKUMEN" class="form-control" style="width:90px;background:#fff" wajib="yes" value="<?=$sess['TGL_DOKUMEN']; ?>" readonly/><span class="input-group-addon"><i class="fa fa-calendar"></i></span></div>
                            </td>
                        </tr>
                    	<tr><td colspan="2" valign="top"><h5 class="smaller lighter blue"><b>Dokumen Masterlist</b></h5></td></tr>
                        <tr>
                        	<td>Nomor Masterlist</td>
                            <td><input type="text" name="BARANG[NO_MASTER_LIST]" id="NO_MASTER_LIST" class="text" wajib="yes" value="<?=$sess['NO_MASTER_LIST']; ?>" /></td>
                        </tr>
                        <tr>
                        	<td>Tanggal Masterlist</td>
                            <td><div class="input-group" style="width:3em;float:left;margin-bottom:0px;margin-right:5px"><input type="text" name="BARANG[TGL_MASTER_LIST]" id="TGL_MASTER_LIST" class="form-control" style="width:90px" wajib="yes" value="<?=$sess['TGL_MASTER_LIST']; ?>" onFocus="ShowDP(this.id);" onMouseOver="ShowDP(this.id);" /><span class="input-group-addon"><i class="fa fa-calendar"></i></span></div></td>
                        </tr>
                    </table> 
                </td>
          	</tr>
