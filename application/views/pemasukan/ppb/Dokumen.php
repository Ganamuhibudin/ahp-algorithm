...
<?php if(!$list){?>
	<form id="fdokumen_" action="<?= site_url()."/pemasukan/dokumen/ppb"; ?>" method="post" autocomplete="off" list="<?= site_url()."/pemasukan/detil/dokumen/ppb" ?>">
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="DOKUMEN[NOMOR_DOKUMEN]" id="NOMOR" class="text" value="<?= $sess['NOMOR_DOKUMEN']; ?>" maxlength="30" wajib="yes"/></td>
            </tr>
            
            <tr>
                <td>Tanggal </td>
                    <td><div class="input-group" style="width:3em;float:left;margin-bottom:0px"><input type="text" name="DOKUMEN[TANGGAL_DOKUMEN]" id="TANGGAL" class="form-control" style="width:90px" value="<?= $sess['TANGGAL_DOKUMEN']; ?>" maxlength="30" onfocus="ShowDP(this.id);" onMouseOver="ShowDP(this.id);" wajib="yes"/><span class="input-group-addon"><i class="fa fa-calendar"></i></span></div>&nbsp; YYYY-MM-DD</td>
            </tr> 
            <tr>
                <td colspan="2">&nbsp;</td>
            </tr>
            <tr>
            	<td>&nbsp;</td>
                <td>
              		<a href="javascript:void(0);" class="btn btn-success btn-m" id="ok_" onclick="save_detil('#fdokumen_','msgdokumen_');"><i class="icon-save"></i>&nbsp;<?= ucfirst($act);?></a>&nbsp;
