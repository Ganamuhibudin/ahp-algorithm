...
function PKBInput(form,jenis,aju){
	...
	var ValPKB=$("#fbc33_ #KATEGORI_EKSPOR").val();
...
function getHarga(form){
	...
	//alert(kdHarga);
		if(kdHarga != ""){	
			if(kdHarga==3){
				 document.fbc33_.FOB.value = FOB;
				 document.fbc33_.FREIGHT.value = nilaiFreight;
				 document.fbc33_.ASURANSI.value = nilaiAsuransi;
				 document.fbc33_.FOB_CONV.value = ThausandSeperator('',FOB,4);
				 document.fbc33_.FREIGHT_CONV.value = ThausandSeperator('',nilaiFreight,4);
				 document.fbc33_.ASURANSI_CONV.value = ThausandSeperator('',nilaiAsuransi,4);
				 document.fbc33_.KODE_HARGA.value = kdHarga;
				 document.fbc33_.N_INVOICE.value = nilaiInvoice;
				 document.fbc33_.N_CIF.value = CIF;
			}else if(kdHarga==1){
				 document.fbc33_.FOB.value = CIF;
				 document.fbc33_.FREIGHT.value = nilaiFreight;
				 document.fbc33_.ASURANSI.value = nilaiAsuransi;
				 document.fbc33_.FOB_CONV.value = ThausandSeperator('',CIF,4);
				 document.fbc33_.FREIGHT_CONV.value = ThausandSeperator('',nilaiFreight,4);
				 document.fbc33_.ASURANSI_CONV.value = ThausandSeperator('',nilaiAsuransi,4);
				 document.fbc33_.KODE_HARGA.value = kdHarga;
				 document.fbc33_.N_INVOICE.value = nilaiInvoice;
				 document.fbc33_.N_CIF.value = FOB;
			}
		}
...
function getPopup(form){
	...
	if(getQQ!=''){
	 ...
	 document.fbc33_.KODE_ID_QQ.value = kode_id;
	 document.fbc33_.ID_QQ.value = id;
	 document.fbc33_.NAMA_QQ.value = nama;
	 document.fbc33_.ALAMAT_QQ.value = alamat;
	 document.fbc33_.NIPER_QQ.value = niper;
	 closedialog('divppjk');
