	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {			
			...
			switch( type ) {
				...
				break;
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><input type="button" class="btn btn-primary btn-sm" value="' + $.alerts.okButton + '" id="popup_ok" /> <input type="button" class="btn btn-danger btn-sm" value="' + $.alerts.cancelButton + '" id="popup_cancel" /></div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
				...
				break;
				case 'confirm2':
					$("#popup_message").after('<div id="popup_panel"><input type="button" class="btn btn-primary btn-sm" value="' + $.alerts.yesButton + '" id="popup_ok" /> <input type="button" class="btn btn-danger btn-sm" value="' + $.alerts.noButton + '" id="popup_cancel" /></div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
						if( callback ) callback(true);
					});
				...
				break;
				case 'prompt':
					$("#popup_message").append('<br /><input type="text" size="30" id="popup_prompt" />').after('<div id="popup_panel"><input type="button" class="btn btn-primary btn-sm" value="' + $.alerts.okButton + '" id="popup_ok" /> <input type="button" class="btn btn-danger btn-sm" value="' + $.alerts.cancelButton + '" id="popup_cancel" /></div>');
				...
				case 'popdialog':					
					...
					$("#popup_message_dialog").after('<div id="popup_panel"><input type="button" class="ui-icon" style="background-position: -96px -128px;" value="' + $.alerts.CloseButton + '" id="popup_ok" /></div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
						callback(true);
					});
				...
				break;
				case 'popup':
					$("#popup_content_popup").after('<div id="popup_panel_popup"><button type="button" class="btn btn-small btn-primary" id="popup_close"><span class="icon-remove"></span>Close</button></div>');
		...
		_showPopup: function(title, msg, value, type, callback, data, width, height) {
			...
			body_append+= '<img id="popup_close_popup" src="'+base_url+'assets/images/close.png" alt="Close" title="Close" style="line-height:1.75em; cursor:pointer; width:95%; padding-top:17%; padding-right:13%"/>';
			body_append+= '	</span>';
			body_append+= '	<div id="popup_title_popup" style="padding-left:1em;"></div>';
		...
		_showPopupTwo: function(title, msg, value, type, callback, data, width, height){
			...
			body_append+= '<span style="float:right;">';
			//body_append+= '<button id="popup_close_popup" class="btn" type="button"><i class="icon-remove"></i></button>';
			body_append+= '<img id="popup_close_popup_two" src="'+base_url+'assets/images/close.png" alt="Close" title="Close" style="line-height:1.75em; cursor:pointer; padding-top:17%; padding-right:13%;"/>';
			body_append+= '	</span>';
			body_append+= '	<div id="popup_title_popup_two" style="padding-left:1em;"></div>';
